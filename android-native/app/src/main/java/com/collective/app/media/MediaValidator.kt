...
object MediaValidator {
    ...
    private const val maxAudioBytes = 50L * 1024L * 1024L
    ...
    private val audioTypes = setOf("audio/mpeg", "audio/mp4", "audio/aac", "audio/wav", "audio/x-wav", "audio/webm")
    ...
    fun inspect(context: Context, uri: Uri): MediaValidationResult {
        ...
        val mediaType = when {
            ...
            mimeType in audioTypes -> MediaType.AUDIO
        ...
        if (sizeBytes > 0) {
            ...
            if (mediaType == MediaType.AUDIO && sizeBytes > maxAudioBytes) {
                return MediaValidationResult.Invalid("This audio file is too large for the prototype.")
            }
        }
