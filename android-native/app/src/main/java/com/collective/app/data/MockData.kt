...
object MockData {
    ...
    val contributors = listOf(
        Contributor("Alyssa Chen", "Top Contributor", "Helps members find their voice and speak with clarity.", "AC"),
    ...
    val labs = listOf(
        LabSpace("Communication Lab", "Practice hard conversations with clear feedback.", "Reliable trust level", "Feedback sprint this week"),
