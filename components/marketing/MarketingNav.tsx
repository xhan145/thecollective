...
export default function MarketingNav() {
  return (
    <header className="sticky top-0 z-40 w-full border-b border-[#EFE7D8]/70 bg-[#FFF8EE]/95 backdrop-blur-xl">
      <nav className="mx-auto flex w-full max-w-6xl items-center justify-between px-5 py-3 lg:px-8">
        ...
        <div className="flex items-center gap-2 lg:gap-4">
          ...
          <Link href="/auth" className="hidden text-sm font-bold text-[#38322A] hover:text-[#111111] sm:block">Sign in</Link>
